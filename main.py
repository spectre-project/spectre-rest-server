...
from endpoints import get_balance, get_utxos, get_blocks, get_blockdag, get_circulating_supply, get_spectred_info, \
...
from endpoints.spectred_requests.submit_transaction_request import submit_a_new_transaction
...
print(
    ...
    f"{get_spectred_info}, {get_network}, {get_marketcap}, {get_hashrate}, {get_blockreward}"
